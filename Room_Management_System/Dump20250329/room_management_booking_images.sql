...
CREATE TABLE `booking_images` (
  `BookingImageId` int NOT NULL AUTO_INCREMENT,
  `BookingId` int NOT NULL,
  `DateUploaded` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Image` longblob NOT NULL,
  PRIMARY KEY (`BookingImageId`),
...
LOCK TABLES `booking_images` WRITE;
/*!40000 ALTER TABLE `booking_images` DISABLE KEYS */;
/*!40000 ALTER TABLE `booking_images` ENABLE KEYS */;
UNLOCK TABLES;
